...
_.reject = function(array, test) {
     return _.filter(array, function (element, i, arr) {
...
// _.partition = function(array, test) {
    // return output = [_.filter(array,test]
// }
...
_.pluck = function(array, propertyName) {
   let output = [];
   _.map (array, function(element, i, arr){
       if (element === array[i]) {
...
*/
 ...
 // undefined
    ...
    // if every value is in array return true else return false
...
_.reduce = function (array, test, start) {
    ...
    if (start !== undefined) {
        ...
        _.each (array, function (element, i, arr) {
            previous = test (previous, element, i);
        });
    } else {
        previous = array[0];
        _.each (array, function (element, i, arr) {
